...
When applied, the policy will iterate through all subnets in all AWS regions and ensure the matching subnet reference in Cloud Management has the correct name.
...
- Update Subnet name in Cloud Management to match Subnet name in AWS
