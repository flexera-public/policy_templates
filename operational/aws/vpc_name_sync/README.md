...
For example if a user selects the "Update VPCs" action while applying the policy, all the resources that didn't satisfy the policy condition will be updated.
...
- Update network name in Cloud Management to match VPC name in AWS
