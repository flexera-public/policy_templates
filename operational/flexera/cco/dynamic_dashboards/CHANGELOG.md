...
- Added "Cost Period" parameter to allow user selection of time range for dashboard data
- Added "Total Cost" to Incident to enable identifying dashboards user should create and potentially in what priority
