...
- *Restrict Resource Types* - Whether or not to gather tags only for important resource types, such as VMs, volumes, databases, etc. Can significantly reduce policy execution time at the cost of missing tags for more minor resource types.
