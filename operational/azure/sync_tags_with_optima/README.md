...
For example if a user selects the "Add Tags" action while applying the policy template, all the resources that didn't satisfy the policy condition will get tagged.
