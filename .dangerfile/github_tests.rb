...
def github_pr_bad_title?(github)
  ...
  if !github.pr_title.match?(pol_matcher) && !github.pr_title.match?(fopts_matcher)
    fail_message = "### **Github Pull Request**\n[[Info](https://github.com/flexera-public/policy_templates/blob/master/CONTRIBUTING.md#3-make-a-pull-request)] Pull Request has improper title. Title should always begin with the JIRA ticket id, followed by a description, like in the following examples:\n\n"
...
def github_pr_missing_summary?(github)
  ...
  fail_message = ""
  fail_message = "### **Github Pull Request**\n[[Info](https://github.com/flexera-public/policy_templates/blob/master/CONTRIBUTING.md#3-make-a-pull-request)] Pull Request is missing summary. Please provide a summary of your Pull Request." if github.pr_body.length < 10
...
def github_pr_missing_labels?(github)
  ...
  fail_message = ""
  fail_message = "### **Github Pull Request**\n[[Info](https://github.com/flexera-public/policy_templates/blob/master/CONTRIBUTING.md#3-make-a-pull-request)] Pull Request is missing labels. Please add labels to this Pull Request." if github.pr_labels.empty?
