...
Manual migration ahead of this schedule is recommended to ensure optimal configuration of workloads. In most cases, storage capacity costs should be lower for GPv2, especially if you take advantage of cool or archive tiering for infrequently accessed blobs, but transaction costs may be higher for workloads with a large number of write or list transactions.
