...
For example if a user selects the "Terminate Stopped Instances" action while applying the policy, all the identified stopped instances will be terminated.
