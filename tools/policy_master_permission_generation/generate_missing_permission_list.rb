...
# encoding: UTF-8
# Identifies policy template files in the repo that are missing from validated_policy_templates.yaml
# and writes the list to data/policy_permissions_list/missing_policy_templates.{json,yaml}.
