...
Before running:
  - Enable Cloud Billing Catalog API and Compute Engine API.
  - Set up your Google Cloud credentials (e.g., export GOOGLE_APPLICATION_CREDENTIALS).
...
def main():
    ...
    output_path = "data/cloud_data/google/google_vm_pricing.json"
