...
As you follow the official docs, you can use the recommended configurations below.
 ...
 - On the **Deployment options**
  ...
  - Construct **IAM Role ARN** for AWS STS Credential Setup in Flexera Automation
    ...
    **See [Flexera Docs > Automation > AWS STS Multi-Account Credential Usage](https://docs.flexera.com/flexera-one/automation/automation-administration/managing-credentials-for-policy-access-to-external-systems/provider-specific-credentials#aws) for more information.**
