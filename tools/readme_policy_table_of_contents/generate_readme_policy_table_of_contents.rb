...
# Reads the active policy list and builds README.md with a categorized table of contents
# of all published policy templates, grouped by provider and service.
...
if $PROGRAM_NAME == __FILE__
  ...
  readme_string << "\n"
  readme_string << "These templates can generate savings estimates for your environment. The incidents they raise are scraped for recommendations for the [Cost Optimization](https://docs.flexera.com/flexera-one/cloud/using-cloud-cost-optimization/viewing-potential-savings) section of Flexera One.\n"
  readme_string << "\n"
