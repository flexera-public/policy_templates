...
This policy checks all Azure SQL Servers to ensure that Vulnerability Assessment has a list of email addresses to notify. An incident is raised with the offending SQL Servers if any are found that don't.
