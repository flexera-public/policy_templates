...
This policy template reports on AWS Relational Database Service (RDS) instances that do not have encrypted storage. Optionally, this report can be emailed, and these instances can be terminated after approval.
