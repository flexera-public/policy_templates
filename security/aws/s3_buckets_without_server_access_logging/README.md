...
This policy template reports any AWS S3 buckets that do not have server access logging enabled. Optionally, it emails this report and enables server access logging.
