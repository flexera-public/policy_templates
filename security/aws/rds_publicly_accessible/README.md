...
This policy template uses the AWS RDS API to gather information on all RDS instances in the AWS account. An RDS instance is determined to be publicly accessible if the API returns the following fields for an instance:
