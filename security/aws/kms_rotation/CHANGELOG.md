...
- Added a region-error-reporting incident that alerts if the policy is unable to retrieve KMS key data from one or more AWS regions due to permission or configuration errors.
