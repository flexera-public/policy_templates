...
This policy template reports if the root user account for an AWS account does not have MFA (multi-factor authentication) enabled. Optionally, this report can be emailed.
