...
This repository contains a library of open source [Flexera Policy Templates](https://docs.flexera.com/flexera-one/automation/managing-and-using-the-automation-catalog). All contributions are shared under the MIT license.

<!--
  This README.md file is generated by a script. Do not edit this file directly.
  Instead, edit /tools/readme_policy_table_of_contents/HEADER.txt and
  /tools/readme_policy_table_of_contents/FOOTER.txt as needed.
-->
...
* To upload the template to your account, navigate to the **Automation** section in [Flexera One](https://app.flexera.com). Ensure you have the role to access policy management in Flexera One. Learn More about [Policy Access Control](https://docs.flexera.com/flexera-one/automation/).
...
* [Getting Started](https://docs.flexera.com/flexera-one/automation/)
* [Reference Documentation](https://docs.flexera.com/flexera-one/automation/automation-reference-information/)
* [Policy Template Language](https://docs.flexera.com/flexera-one/automation/automation-reference-information/policy-template-language/)
