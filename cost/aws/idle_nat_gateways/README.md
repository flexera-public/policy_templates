...
For example, if a user selects the "Delete Idle NAT Gateways" action while applying the policy, all the gateways that didn't satisfy the policy condition will be deleted.
