...
- *Findings To Raise* - Which finding types this policy should evaluate and raise as incidents. Deselect a finding to suppress it. All four are selected by default.
