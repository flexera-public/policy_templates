...
For example if a user selects the "Resize Instances" action while applying the policy template, all the identified instances that didn't satisfy the policy condition will be resized.
