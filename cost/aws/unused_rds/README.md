...
This policy template is no longer being updated. The [AWS Rightsize RDS Instances](https://github.com/flexera-public/policy_templates/tree/master/cost/aws/rightsize_rds_instances/) policy now includes this functionality and is the recommended policy for getting unused RDS instance recommendations.
