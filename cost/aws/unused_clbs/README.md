...
For example if a user selects the "Delete Unused Classic Load Balancers" action while applying the policy template, all the resources that didn't satisfy the policy condition will be terminated.
