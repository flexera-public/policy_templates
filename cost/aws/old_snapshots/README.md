...
- [**AWS Credential**](https://docs.flexera.com/flexera/EN/Automation/ProviderCredentials.htm#automationadmin_1982464505_1121575) (*provider=aws*) whichh has the following permissions:
  - `EC2:DescribeRegions`
  - `ec2:DescribeImages`
