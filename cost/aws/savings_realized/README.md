...
This policy template is no longer being updated. The more accurate "Savings" and "Savings Percent" cost metrics now available natively in Flexera CCO, in conjunction with the [Dashboards](https://docs.flexera.com/flexera-one/cloud/using-cloud-cost-optimization/accessing-the-cloud-dashboard/#usingcco_3910196062_1183924) and [Tabular View](https://docs.flexera.com/flexera-one/cloud/using-cloud-cost-optimization/tabular-view#usingcco_3910196062_1186809) feature, should be used instead.
...
- This policy template uses [savings metric](https://docs.flexera.com/flexera-one/cloud/using-cloud-cost-optimization/tabular-view#tabularview_3352643092_1192596) calculated as difference between list price and cost.
