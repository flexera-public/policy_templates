...
This policy template reports on unused IP addresses and, optionally, deletes them. An IP address is considered unused if it is currently detached and has been detached for a user-specified number of days.
