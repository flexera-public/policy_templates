...
This policy template is no longer being updated. The [Google Unused IP Addresses](https://github.com/flexera-public/policy_templates/tree/master/cost/google/unused_ip_addresses/) policy template should be used instead.
