...
If APIs & services are not enabled for a project, the policy will skip that particular project and executes it. On the next run if services are enabled, then the project will be taken into consideration.
