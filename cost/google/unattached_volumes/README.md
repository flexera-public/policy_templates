...
This policy template is no longer being updated. The [Google Idle Persistent Disk Recommender](https://github.com/flexera-public/policy_templates/tree/master/cost/google/idle_persistent_disk_recommendations/) policy template should be used instead.
