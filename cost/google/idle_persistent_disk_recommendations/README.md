...
NOTE: If you prefer to receive recommendations produced by Flexera rather than the Google Recommender service, or also need recommendations for rightsizing persistent disks, please use the [Google Rightsize Persistent Disks](https://github.com/flexera-public/policy_templates/tree/master/cost/google/rightsize_persistent_disks) policy template instead of this one.
