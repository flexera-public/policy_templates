...
NOTE: If you prefer to receive recommendations produced by Flexera rather than the Google Recommender service, please use the [Google Unused IP Addresses](https://github.com/flexera-public/policy_templates/tree/master/cost/google/unused_ip_addresses) policy template instead of this one.
