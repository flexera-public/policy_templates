# Turbonomics Delete Unattached Volumes Recommendations AWS

## What it does

The Turbonomics Delete Unattached Volumes Recommendations AWS policy utilizes Turbonomics https://turbonomic.com/api/v3/markets/{market_uuid}/actions endpoint to provide AWS unused virtual volume recommendations for deletion. From these recommendations we provide monthly savings estimates based on Turbonomics per hour costs
