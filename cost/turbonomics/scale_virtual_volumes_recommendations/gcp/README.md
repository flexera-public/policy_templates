# Turbonomics Scale Virtual Volumes Recommendations GCP

## What it does

The Turbonomics Scale Virtual Volumes Recommendations GCP policy utilizes Turbonomics https://turbonomic.com/api/v3/markets/{market_uuid}/actions endpoint to provide GCP recommendations for instance scaling of virtual volumes. From these recommendations we provide monthly savings estimates based on Turbonomics per hour costs
