# Turbonomics Allocate Virtual Machine Recommendations GCP

## What it does

The Turbonomics Allocate Virtual Machines Recommendations GCP policy utilizes Turbonomics https://turbonomic.com/api/v3/markets/{market_uuid}/actions endpoint to provide GCP VM allocation recommendations for Reserved Instance coverage. From these recommendations we provide monthly savings estimates based on Turbonomics per hour costs
