# Turbonomics Scale Databases Recommendations AWS

## What it does

The Turbonomics Scale Databases Recommendations AWS policy utilizes Turbonomics https://turbonomic.com/api/v3/markets/{market_uuid}/actions endpoint to provide AWS recommendations for size scaling databases. From these recommendations we provide monthly savings estimates based on Turbonomics per hour costs
