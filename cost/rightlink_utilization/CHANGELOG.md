v1.12
-----
- Separate the Utilization from the downsize actions.  The downsize actions are now in [Downsize Instance](/rightscale/policy_templates/cost/downsize_instance/README.md)
