...
For example if a user selects the "Downsize Underutilized Instances" action while applying the policy template, all the resources that didn't satisfy the policy condition will be resized.
