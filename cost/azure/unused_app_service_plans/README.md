...
For example if a user selects the "Delete Unused App Service Plans" action while applying the policy template, all the Azure App Service Plans that didn't satisfy the policy condition will be deleted.
