...
For example if a user selects the "Delete Storage Accounts" action while applying the policy, all of the Storage Accounts that didn't satisfy the policy condition will be deleted.
