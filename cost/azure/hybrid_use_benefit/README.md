...
For example if a user selects the "Apply Hybrid Use Benefit" action while applying the policy template, all of the Windows VMs without AHUB that qualify will have AHUB enabled.
