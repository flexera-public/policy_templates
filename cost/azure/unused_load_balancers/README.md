...
For example if a user selects the "Delete Unused Load Balancers" action while applying the policy template, all the Azure Load Balancers that didn't satisfy the policy condition will be deleted.
