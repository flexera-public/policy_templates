...
- Downsize Azure MySQL Single Server (if underutilized) after approval
- Delete Azure MySQL Single Server (if unused) after approval
...
- [**Azure Resource Manager Credential**](https://docs.flexera.com/flexera-one/automation/automation-administration/managing-credentials-for-policy-access-to-external-systems/provider-specific-credentials#automationadmin_109256743_1124668) (*provider=azure_rm*) which has the following permissions:
  ...
  - `Microsoft.DBforMySQL/servers/update`*
