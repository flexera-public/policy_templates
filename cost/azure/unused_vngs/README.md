...
For example if a user selects the "Delete Unused Virtual Network Gateways" action while applying the policy template, all the Azure Virtual Network Gateways that didn't satisfy the policy condition will be deleted.
