...
[Describe the use case for this feature request or new policy template request]
...
[Please provide any relevant code snippets (ie. datasource,escalation,policy, RCL, etc.) as it relates to the bug]
