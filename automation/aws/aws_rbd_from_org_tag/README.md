# AWS Rule-Based Dimension From Account Tags (AWS Organizations API)

## What It Does

This policy template creates and updates custom Rule-Based Dimensions that surface the specified AWS Account tag keys provided by the AWS Organizations API. This allows costs to be sliced by the values of the tag keys in question. Rules added to these rule-based dimensions manually, or by other policy templates, will not be deleted.
