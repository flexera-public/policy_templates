...
NOTE: If applying this policy template multiple times for multiple AWS master payer accounts, please give each applied policy a distinct name. This is to ensure the policy templates do not overwrite each other's work.
