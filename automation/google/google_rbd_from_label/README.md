...
**NOTE: Project labels are distinct from resource manager tags. If you want to use resource manager tags, please use the [Google Rule-Based Dimension From Project Tags](https://github.com/flexera-public/policy_templates/tree/master/automation/google/google_rbd_from_tag) policy template.**
