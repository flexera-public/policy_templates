...
- [**Spot Credential**](https://docs.flexera.com/flexera-one/automation/automation-administration/managing-credentials-for-policy-access-to-external-systems/provider-specific-credentials#spot) (*provider=spotinst*) created within a Spot organization that has the Spot Eco product.
